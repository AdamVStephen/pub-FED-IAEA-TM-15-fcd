...
\includegraphics{nimbus-floorplan}
%% Use \caption command for figure caption and label.
% Ref slide 29
\caption{CMS End Point Interactions}\label{fig5}
...
\centering%% For centre alignment of image.
% Page 17 
\includegraphics{HIL-Arch}
%% Use \caption command for figure caption and label.
% Ref slide 12
\caption{Nimbus floorplan}\label{fig2}
%% https://en.wikibooks.org/wiki/LaTeX/Importing_Graphics#Importing_external_graphics
\end{figure}
...
%% Use \caption command for figure caption and label.
% Ref slide 12
\caption{Nimbus floorplan}\label{fig3}
%% https://en.wikibooks.org/wiki/LaTeX/Importing_Graphics#Importing_external_graphics
\end{figure}
...
The authors welcome engagement from other researchers and fusion industry companies.

Next steps will include creating
